...
EXAMPLE_GROUP = (
    "iambic_test_group"  # This IDC group must exist in the target cloud resource
)
EXAMPLE_USER = "iambic_test_user@iambic.org"  # This IDC user must exist in the target cloud resource
