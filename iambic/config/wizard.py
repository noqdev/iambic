...
class ConfigurationWizard:
    def __init__(self, repo_dir: str):
        ...
        self.profile_name = ""
        self.__hub_account_id = None
        self.__spoke_role_is_read_only = None
    ...
    @property
    def hub_account_id(self):
        if self.config.aws:
            self.__hub_account_id = self.config.aws.hub_role_arn.split(":")[4]

        return self.__hub_account_id

    @property
    def spoke_role_is_read_only(self):
        if self.config.aws:
            self.__spoke_role_is_read_only = self.config.aws.spoke_role_is_read_only

        return self.__spoke_role_is_read_only
