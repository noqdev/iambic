...
This guide assumes that you already have a [local git repository](/technical_reference/installation/local_git_repo) that contains your IAMbic templates. If you have not yet setup a local git repository for IAMbic to store templates in, head on over to [setup the local git repository](/technical_reference/installation/local_git_repo) first.

### Setting up your local environment

:::info
Setup a local environment only if you want to develop IAMbic and contribute code to the IAMbic repo. There are specific [contributing guidelines](https://github.com/noqdev/iambic/CONTRIBUTING.md).
:::
