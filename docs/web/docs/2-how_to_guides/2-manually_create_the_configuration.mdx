...
You can use the [wizard](configure_iambic_with_wizard) to quickly start creating your configuration file.

This document provides an overview of the YAML configuration for NOQ::Core::Config.
This configuration is used to specify AWS accounts and organizations that IAMbic has access to, via [Hub and Spoke roles](/technical_reference/aws_hub_and_spoke_roles).
