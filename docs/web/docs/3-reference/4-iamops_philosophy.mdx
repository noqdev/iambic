...
IAMbic follows an IAMOps philosophy, which is a combination of GitOps and IAM. Check out our
[Example IAMbic Templates repository documentation](/reference/example_iambic_templates_repository#iamops-flow)
for an example of this flow in action.
