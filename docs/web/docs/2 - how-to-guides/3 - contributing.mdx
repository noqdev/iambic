...
This guide assumes that you already have a [local git repository](../installation/local_git_repo) that contains your IAMbic templates. If you have not yet setup a local git repository for IAMbic to store templates in, head on over to [setup the local git repository](../installation/local_git_repo) first.
