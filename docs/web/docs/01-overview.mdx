...
IAMbic leverages a [Github App](/getting_started/install_and_configure#setup-github-application) that automatically run IAMbic plan and apply workflows via CI/CD.
