...
Check out our [Example IAMbic Templates repository documentation](/reference/example_iambic_templates_repository) to see examples of
IAMbic templates and the structure of an iambic templates repository.
