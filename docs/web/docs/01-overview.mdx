...
IAMbic includes [Github Actions](/getting_started/github) that automatically run IAMbic workflows in CI/CD.
...
accounts by centralizing them into a single Git repository. IAMbic also includes Github actions that keep your permissions
