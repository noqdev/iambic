...
title: Google
---
<!-- #TODO not sure where this goes. It's useful metainformation, but not really part of the flow of the tutorial. -->
...
<!-- #TODO do these need copy buttons? -->
...
That's it, you've completed the setup configuration connecting your Google Groups to IAMBic. Now you will practice using IAMbic to execute basic group management skills.
