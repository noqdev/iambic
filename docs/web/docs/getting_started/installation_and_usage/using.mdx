...
In order to use IAMbic, first **Install IAMBic** by following any of these methods:

* [Install via Docker](./install_via_docker.mdx) **preferred method**
* [Install via the Wheel](./install_via_the_wheel.mdx)
* [Download the Repo](./download_the_repo.mdx)
