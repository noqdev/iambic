...
10. Create temporary access rules for your Permission Set (Requires Noq Enterprise)
11. Provide temporary (break-glass) access to your AWS Identity Center Permission Sets
12. Create and Manage an IAM Managed Policy
