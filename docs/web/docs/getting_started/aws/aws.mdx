...
2. Import AWS resources into Iambic
3. Create a role across multiple AWS accounts
4. Create dynamic permissions for this role, which vary depending on account
5. Create temporary permissions, that Iambic will automatically expire
6. Provide temporary (break-glass) access to your AWS Identity Center Permission Sets
...
## 3 Create an IAM role across multiple accounts
...
As usual, run the following command to reflect the changes in your cloud environment immediately.
