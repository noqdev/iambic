...
Once these requisites are complete, you can select from a Python or Docker based install (TODO: is that true?)(TODO those should link to the right sections)
