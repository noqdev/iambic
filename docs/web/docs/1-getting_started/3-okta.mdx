...
* OKTA_DOMAIN=<your_okta_domain> # ex: https://dev-12345.okta.com/
* OKTA_ORG_NAME=<your_okta_org_name> # ex: development. This is a friendly name to identify your Okta organization
* OKTA_API_TOKEN=<your_okta_api_token> # An administrative API token for your Okta organization, follow the instructions in the following steps to create one. 
