...
<a href={getGitOrganizationLink('noqdev')} target="_blank" id={elementIds.gitHubOrgAnchorTag}>github.com/organizations/<label id='outputGithubOrg'>noqdev</label>/settings/apps</a>
