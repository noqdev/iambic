...
We are re-working the IAMbic GitHub App process. Docs update soon.

:::

### Create a GitHub App in your organization (New)
...
### Create a GitHub App in your organization (Old)
