...
3. Make sure you have admin access for the IAMbic GitHub repository that can perform the following tasks:
	...
	2. Add GitHub Apps
4. Have an AWS admin rights to deploy IAMbic GitHub integration.
...
Remember to set the visibility setting to `Private`. This repository will stores IAMbic templates for your organization. <!-- #TODO include a picture or video -->
...
Remember to set the visibility setting to `Private`. This repository will stores IAMbic integration summaries for your organization. <!-- #TODO include a picture or video -->
