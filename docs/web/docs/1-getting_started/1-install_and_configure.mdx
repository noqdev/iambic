...
> More information: if you want more information on installing the [docker container](/technical_reference/installation/install_via_docker), you can also [install the wheel](/technical_reference/installation/install_via_the_wheel) or [check out the repo](/technical_reference/installation/download_the_repo).
