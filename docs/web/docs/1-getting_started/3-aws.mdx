...
organization into your Iambic configuration file) or specify the individual AWS accounts that you wish to
manage. You can find more specific guidance on how to run iambic setup in our
