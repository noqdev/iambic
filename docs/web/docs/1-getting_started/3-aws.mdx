...
A possible scenario is your prod account requires certain managed deletion for compliance reasons. In contrast, you want your developers to be able clean up after themselves in the dev account.
