...
```bash
# Create a directory in your iambic-templates repo
mkdir -p resources/aws/iam/identity_center/permission_sets/

# Open the yaml file with your favorite editor, and save the template you crafted above
code resources/aws/iam/identity_center/permission_sets/iambic_test_permission_set.yaml
```
...
```bash
iambic apply resources/aws/iam/identity_center/permission_sets/iambic_test_permission_set.yaml
```
